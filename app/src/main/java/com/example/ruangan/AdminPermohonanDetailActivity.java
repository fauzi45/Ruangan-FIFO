...
public class AdminPermohonanDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_permohonan_detail);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AdminPermohonanDetailActivity.this,AdminPermohonanRuangan.class);
        ...
        ref.child(orderId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AdminPermohonanDetailActivity.this, "Permohonan berhasil "+selectedOptions, Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AdminPermohonanDetailActivity.this, "Gagal mengganti status", Toast.LENGTH_SHORT).show();
                    }
                });
    }
